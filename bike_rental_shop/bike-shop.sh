    ...
    then
        ...
        then
            ...
            then
                ...
                # insert bike rental
                INSERT_RENTAL_RESULT=$($PSQL "INSERT INTO rentals(bike_id, customer_id) 
                VALUES($BIKE_ID_TO_RENT,$CUSTOMER_ID)")
    ...
    then
        ...
        then
            ...
            then
                ...
                INNER JOIN customers USING(customer_id) 
                WHERE phone='$PHONE_NUMBER' AND date_returned IS NULL AND bike_id=$BIKE_ID_TO_RETURN") 
                #if input not rented
                if [[ -z $RENTAL_ID ]]
                then
                    #send to main menu
